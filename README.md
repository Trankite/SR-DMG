...
**基础数值**：右键 “攻击力/生命值/防御力/速度” 切换为 “基础攻击力/...”

**固定数值**：右键 “特殊倍率” 切换为 “固定数值”（直接加在攻击区）

**其他属性**：右键 “效果命中/效果抵抗” 切换为 “充能效率/治疗提高”

**连续操作**：右键 “快捷取参数” 及 计算器相关 的勾选框，锁定/解锁

**界面透明**：空白区域长按右键，界面透明，松开恢复

**取消保存**：右键 “等待保存” 弹出 取消保存 的确认框

**执行指令**：右键 “指令” 立即执行，或在文本框内按下 Enter

**指令提示**：右键 “指令” 显示指令提示（文本框为空时）

**伤害比较**：勾选 “记录此伤害” 后，显示伤害提升百分比（若 0% 则不显示）
